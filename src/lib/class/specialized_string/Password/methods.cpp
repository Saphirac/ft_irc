...
/*   Updated: 2024/03/14 17:38:25 by gle-mini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline static bool is_nolfcrspcl(char const c) { return std::string("\r\n :").find(c) == std::string::npos; }

inline static bool is_nolfcrsp(char const c) { return std::string("\r\n ").find(c) == std::string::npos; }

inline static bool is_nolfcr(char const c) { return std::string("\r\n").find(c) == std::string::npos; }
