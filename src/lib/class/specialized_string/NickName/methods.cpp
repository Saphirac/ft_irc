...
/*   Updated: 2024/03/11 01:39:03 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return this->size() <= MAXIMUM_LENGTH_FOR_NICKNAME && letters_specials.find(this->at(0)) != this->npos
	    && this->find_first_not_of(LETTERS DIGITS SPECIALS, 1) == this->npos;
}
