...
/*   Updated: 2024/03/15 01:48:05 by mcourtoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
Bot::Bot(int const port, std::string const &password) : _socket(socket(AF_INET, SOCK_STREAM | SOCK_NONBLOCK, 0)), _password(password)
{
	// Socket creation
	if (this->_socket < 0)
